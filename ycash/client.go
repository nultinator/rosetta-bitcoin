...
import (
	...
	ycashUtils "github.com/nultinator/rosetta-ycash/utils"
...
const (
	// https://zcash-rpc.github.io/getblock.html
	requestMethodGetBlock requestMethod = "getblock"

	// https://zcash-rpc.github.io/getblockhash.html
	...
	// https://zcash-rpc.github.io/estimatefee.html
...
// Client is used to fetch blocks from ycashd and
// to parse Ycash block data into Rosetta types.
//
...
// ParseBlock returns a parsed ycash block given a raw ycash
...
func (b *Client) parseTransactions(
	...
	logger := ycashUtils.ExtractLogger(ctx, "client")
...
func (b *Client) parseTxOperations(
	...
	for networkIndex, input := range tx.Inputs {
		if ycashIsCoinbaseInput(input, txIndex, networkIndex) {
