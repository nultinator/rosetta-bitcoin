...
type unsignedTransaction struct {
	...
	ScriptPubKeys  []*ycash.ScriptPubKey `json:"scriptPubKeys"`
...
type constructionMetadata struct {
	ScriptPubKeys []*ycash.ScriptPubKey `json:"script_pub_keys"`
}
...
type ParseOperationMetadata struct {
	ScriptPubKey *ycash.ScriptPubKey `json:"scriptPubKey"`
}
